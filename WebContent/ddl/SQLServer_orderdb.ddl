...
INSERT INTO category(categoryName) VALUES ('Retro Tech');       -- ID 1
INSERT INTO category(categoryName) VALUES ('Digital Pets');     -- ID 2
INSERT INTO category(categoryName) VALUES ('Sci-Fi & Nature');  -- ID 3
INSERT INTO category(categoryName) VALUES ('Office & Art');     -- ID 4
INSERT INTO category(categoryName) VALUES ('Miscellaneous');    -- ID 5
...
('Fan', 1, 'Keep your Pentium nice and chilly.', 14.14, 'img/14.gif'),
('Floppy Disk', 1, 'Holds a massive 1.44MB of data.', 6.00, 'img/16.gif'),
('Gears', 1, 'Please excuse the dust, we are working on it.', 2.02, 'img/18.gif'),
('Robot', 1, 'Only speaks binary.', 13.13, 'img/27.gif'),

('Cat', 2, 'He''s trapped behind the screen! Buy now to save him!', 12.12, 'img/7.gif'),
('Dog', 2, 'He''s top dog!', 2.17, 'img/32.gif'),
('Duck', 2, 'It''s duck season!', 5.55, 'img/11.gif'),
('Fish', 2, 'Cheaper than a real aquarium. Blub blub.', 3.33, 'img/15.gif'),
('Gecko', 2, 'Enter the Gecko!', 7.77, 'img/19.gif'),
...
('Flower', 3, 'Stop and smell the pixels.', 8.16, 'img/17.gif'),
('Tree', 3, 'Literally a binary tree.', 9.21, 'img/31.gif'),

('Book', 4, 'Train your brain! Get off the Internet!', 8.88, 'img/5.gif'),
('Clock', 4, 'Countdown to Y2K.', 4.99, 'img/9.gif'),
('Envelope', 4, 'You''ve got mail!', 7.21, 'img/12.gif'),
('Mailbox', 4, 'For sending physical mail. Not sure why you''d do that though.', 5.01, 'img/22.gif'),
('Palette', 4, 'Graphic design is my passion.', 6.66, 'img/25.gif'),
('Scissors', 4, 'Running with these is not recommended.', 7.89, 'img/28.gif'),

('Bomb', 5, 'It''s the bomb!', 80.08, 'img/4.gif'),
('Lava Lamp', 5, 'Groovy, baby!', 11.11, 'img/20.gif'),
('Lemon', 5, 'When life gives you lemons, buy this gif.', 4.44, 'img/21.gif'),
('Milk', 5, 'For the strongest bones. Calcium included.', 9.99, 'img/23.gif'),
('Paddle', 5, 'Ping? Pong.', 8.88, 'img/24.gif'),
('Porthole', 5, 'Sail the high seas.', 12.34, 'img/26.gif');
...
INSERT INTO customer (firstName, lastName, email, phonenum, address, city, state, postalCode, country, userid, password) VALUES ('Patrick', 'Rinn', 'patrick@igifup.com', '250-241-2413', '103 AnyWhere Street', 'Winnipeg', 'MB', 'R3X 45T', 'Canada', 'admin' , 'admin');
...
ALTER TABLE ordersummary ADD orderStatus VARCHAR(20) DEFAULT 'Processing';
UPDATE ordersummary SET orderStatus = 'Processing';