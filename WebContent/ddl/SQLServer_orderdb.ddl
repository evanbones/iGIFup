...
('Atomic Structure', 9, 'Atomic structure icon', 10.00, 'img/1.gif'),
('@ Symbol', 9, '@ symbol icon', 10.00, 'img/2.gif'),
('BBC Micro', 9, 'BBC Micro computer icon', 10.00, 'img/3.gif'),
('Bomb', 9, 'Bomb icon', 10.00, 'img/4.gif'),
('Book', 9, 'Book icon', 10.00, 'img/5.gif'),
('Cactus', 9, 'Cactus icon', 10.00, 'img/6.gif'),
('Cat', 9, 'Cat icon', 10.00, 'img/7.gif'),
('Cellphone', 9, 'Cellphone icon', 10.00, 'img/8.gif'),
('Clock', 9, 'Clock icon', 10.00, 'img/9.gif'),
('Disk', 9, 'Disk icon', 10.00, 'img/10.gif'),
('Duck', 9, 'Duck icon', 10.00, 'img/11.gif'),
('Envelope', 9, 'Envelope icon', 10.00, 'img/12.gif'),
('Explosion', 9, 'Explosion icon', 10.00, 'img/13.gif'),
('Fan', 9, 'Fan icon', 10.00, 'img/14.gif'),
('Fish', 9, 'Fish icon', 10.00, 'img/15.gif'),
('Floppy Disk', 9, 'Floppy disk icon', 10.00, 'img/16.gif'),
('Flower', 9, 'Flower icon', 10.00, 'img/17.gif'),
('Gears', 9, 'Gears icon', 10.00, 'img/18.gif'),
('Gecko', 9, 'Gecko icon', 10.00, 'img/19.gif'),
('Lava Lamp', 9, 'Lava lamp icon', 10.00, 'img/20.gif'),
('Lemon', 9, 'Lemon icon', 10.00, 'img/21.gif'),
('Mailbox', 9, 'Mailbox icon', 10.00, 'img/22.gif'),
('Milk', 9, 'Milk icon', 10.00, 'img/23.gif'),
('Paddle', 9, 'Paddle icon', 10.00, 'img/24.gif'),
('Palette', 9, 'Artist palette icon', 10.00, 'img/25.gif'),
('Porthole', 9, 'Porthole icon', 10.00, 'img/26.gif'),
('Robot', 9, 'Robot icon', 10.00, 'img/27.gif'),
('Scissors', 9, 'Scissors icon', 10.00, 'img/28.gif'),
('Seal', 9, 'Seal icon', 10.00, 'img/29.gif'),
('Shark', 9, 'Shark icon', 10.00, 'img/30.gif'),
('Tree', 9, 'Tree icon', 10.00, 'img/31.gif');
