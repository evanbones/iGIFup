...
('Where It''s @', 9, 'The future of communication!', 7.77, 'img/2.gif'),
...
('Prickly Cactus', 9, 'Youch, it''s sharp! A desert vibe for your homepage.', 6.66, 'img/6.gif'),
('Cyber Kitty', 9, 'Very cute.', 12.12, 'img/7.gif'),
('Nokia Brick', 9, 'Indestructible. Probably includes the Snake game.', 15.00, 'img/8.gif'),
('Y2K Countdown', 9, 'Is the world ending yet? Check the time.', 4.99, 'img/9.gif'),
('Imaginal Disk', 9, 'Meet your brand new image!', 53.42, 'img/10.gif'),
('Duck', 9, 'It''s duck season!', 5.55, 'img/11.gif'),
('You''ve Got Mail', 9, 'E-Snail Mail. The envelope spins when new.', 7.21, 'img/12.gif'),
('Explosion', 9, 'Now I am become death, destroyer of worlds.', 25.00, 'img/13.gif'),
('CPU Cooler', 9, 'Keep your Pentium nice and chilly.', 14.14, 'img/14.gif'),
('Fish', 9, 'Cheaper than a real aquarium. Blub blub.', 3.33, 'img/15.gif'),
('Floppy Disk', 9, 'Holds a massive 1.44MB of data.', 6.00, 'img/16.gif'),
('Digital Daisy', 9, 'Stop and smell the pixels.', 8.16, 'img/17.gif'),
('Under Construction', 9, 'Please excuse the dust, we are working on it.', 2.02, 'img/18.gif'),
('Karma Chameleon', 9, 'He comes and goes... mostly goes.', 7.77, 'img/19.gif'),
...
('Got Milk?', 9, 'For the strongest bones. Calcium included.', 9.99, 'img/23.gif'),
('Ping Pong Paddle', 9, 'Modelled after the first video game.', 8.88, 'img/24.gif'),
('MS Paint', 9, 'Graphic design is my passion.', 6.66, 'img/25.gif'),
('Porthole', 9, 'Surfing the web in style.', 12.34, 'img/26.gif'),
('Domo Arigato', 9, 'Mr. Roboto. Only speaks binary.', 13.13, 'img/27.gif'),
('Cut and Paste', 9, 'Running with these is not recommended.', 7.89, 'img/28.gif'),
('Seal of Approval', 9, 'Arf arf! Approved by the webmaster.', 5.55, 'img/29.gif'),
('Shark', 9, 'We''re gonna need a bigger boat.', 18.00, 'img/30.gif'),
('Binary Tree', 9, 'A natural touch for your digital forest.', 9.21, 'img/31.gif'),
('Top Dog', 9, 'He likes to swim in the dark.', 2.17, 'img/32.gif');
...
UPDATE Product SET productImageURL = 'img/1.gif' WHERE ProductId = 1;
UPDATE Product SET productImageURL = 'img/2.gif' WHERE ProductId = 2;
UPDATE Product SET productImageURL = 'img/3.gif' WHERE ProductId = 3;
UPDATE Product SET productImageURL = 'img/4.gif' WHERE ProductId = 4;
UPDATE Product SET productImageURL = 'img/5.gif' WHERE ProductId = 5;
