...
('Crystal Lattice', 9, 'Science rules!', 9.99, 'img/1.gif'),
...
('Cactus', 9, 'Youch, it''s sharp!', 6.66, 'img/6.gif'),
...
('Paddle', 9, 'Ping? Pong.', 8.88, 'img/24.gif'),
('Palette', 9, 'Graphic design is my passion.', 6.66, 'img/25.gif'),
('Porthole', 9, 'Sail the high seas.', 12.34, 'img/26.gif'),
('Robot', 9, 'Only speaks binary.', 13.13, 'img/27.gif'),
